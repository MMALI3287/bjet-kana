...
const info = {
  ...
  '/kana': {
    header: <span>Welcome to the kana (hiragana and katakana) training!</span>,
    content: (
      <>
        <p className='text-lg text-[var(--secondary-color)]'>
          This is where you can learn and practice the two core
        ...
        <p className='text-lg italic'>
          ...
          <span className='animate-bounce'>customize</span> your learning experience!
        </p>
      </>
    )
  },
  '/kanji': {
    header: <span>Kanji training (coming soon)</span>,
    content: (
      <>
        <p className='text-lg text-[var(--secondary-color)]'>
          This feature is not available in the kana-only version.
        </p>
      </>
    )
  },
  '/vocabulary': {
    header: <span>Vocabulary training (coming soon)</span>,
    content: (
      <>
        <p className='text-lg text-[var(--secondary-color)]'>
          This feature is not available in the kana-only version.
